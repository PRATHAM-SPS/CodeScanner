...
import com.project.androidocr.Api.ApiHandler;
import com.project.androidocr.Api.ApiService;
import com.project.androidocr.Api.PostData;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        compbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<String> execute = apiService.execute(new PostData(mResultEt.getText().toString(),input.getText().toString(), String.valueOf(spinner.getSelectedItem())));
                Log.e("Running",String.valueOf(spinner.getSelectedItem()));
                tvResult.setText("Loading...");

                Intent intent = new Intent(MainActivity.this,ApiHandler.class);
    ...
    private void dialogAbout() {
        new AlertDialog.Builder(this)
                .setTitle("About App")
                .setMessage("This app is made by Team PIP INSTALL.")
